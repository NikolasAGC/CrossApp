    ...
    try {
      switch (action) {
        ...
        case 'modal:open': {
          ...
          await setUiState({ modal: modal || null });
          await rerender();
        ...
        case 'wod:mode': {
          ...
          await rerender();
          ensureActiveLine(root, patchUiState);
          return;
        }
        ...
        case 'wod:next': {
          await patchUiState((s) => {
            ...
            // marca a atual como feita e vai pra próxima não feita
...
function cssEscape(value) {
  // escape mínimo para querySelector (evita quebrar com aspas e caracteres especiais)
